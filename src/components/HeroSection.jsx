...
export const HeroSection = () => {
  return (
    <section id="hero" className="relative min-h-screen flex flex-col items-center justify-center px-4 pt-10 sm:pt-20">
      <div className="container max-w-4xl mx-auto text-center z-10">
        <div className="space-y-4 md:space-y-6">
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight leading-tight">
           <span className="opacity-0 animate-fade-in inline-block"> Hi, I'm </span>
<span className="text-primary opacity-0 animate-fade-in-delay-1 inline-block ml-2"> Ahmad </span>
<span className="text-foreground ml-2 opacity-0 animate-fade-in-delay-2 inline-block">Subair</span>
          ...
          Frontend Developer with 2+ years building web products for businesses and startups. 
          I turn ideas into fast, responsive, and professional web applications — 
          from logistics platforms to AI-powered tools.
          </p>
